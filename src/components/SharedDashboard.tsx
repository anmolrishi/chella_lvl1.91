...
const saveCallAnalytics = async (userId: string, callId: string) => {
  try {
    ...
    const saveSharedDashboardAnalytics = httpsCallable(functions, 'saveSharedDashboardAnalytics');
    const result = await saveSharedDashboardAnalytics({ userId, callId, analyticsData });
